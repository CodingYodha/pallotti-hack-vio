...
import { getVideo, getVideoStatus, getIndividuals, getViolations, markVideoReviewed, unmarkVideoReviewed, getImageUrl } from '../services/api'
                                                        ...
                                                        {!ind.employee_name && (
                                                            <button
                                                                ...
                                                                onClick={() => setNamingPerson({
                                                                    trackId: ind.track_id,
                                                                    snapshotPath: ind.snapshot_path || personViolation?.image_path,
                                                                    individualId: ind.id
                                                                })}
