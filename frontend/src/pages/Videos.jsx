...
function Videos() {
    ...
    const handleShiftConfirm = async () => {
        ...
        try {
            ...
            }, selectedShift, sendEmail, emailAddress)
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-6 pt-4 border-t" style={{ borderColor: 'var(--border-color)' }}>
                                <label className="flex items-center gap-2 cursor-pointer mb-2">
                                    ...
                                    />
                                    <span className="text-sm font-medium">Send batch report on completion</span>
                                </label>
                                ...
                                {sendEmail && (
                                    <input
                                        ...
                                        className="form-input w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm mt-1 mb-2"
                                        required={sendEmail}
